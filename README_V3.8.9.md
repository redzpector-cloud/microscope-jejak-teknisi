...
- Simpan/Share PNG tetap dipertahankan.
- Editor dan anotasi tetap dipertahankan.
- Workflow GitHub Actions tetap JDK 17 + Gradle 8.9 tanpa android-actions/setup-android@v3.

Catatan: build Android tetap dilakukan melalui GitHub Actions.
